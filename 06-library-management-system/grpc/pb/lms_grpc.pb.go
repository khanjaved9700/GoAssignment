...
type BookServiceClient interface {
	...
	GetAllBook(ctx context.Context, in *GetAllBookRequest, opts ...grpc.CallOption) (BookService_GetAllBookClient, error)
...
func (c *bookServiceClient) CreateBook(ctx context.Context, in *CreateBookRequest, opts ...grpc.CallOption) (*CreateBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.BookService/CreateBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) GetAllBook(ctx context.Context, in *GetAllBookRequest, opts ...grpc.CallOption) (BookService_GetAllBookClient, error) {
	stream, err := c.cc.NewStream(ctx, &BookService_ServiceDesc.Streams[0], "/grpc.BookService/GetAllBook", opts...)
	if err != nil {
		return nil, err
	}
	x := &bookServiceGetAllBookClient{stream}
...
type BookService_GetAllBookClient interface {
	Recv() (*GetAllBookResponse, error)
	grpc.ClientStream
}

type bookServiceGetAllBookClient struct {
	grpc.ClientStream
}

func (x *bookServiceGetAllBookClient) Recv() (*GetAllBookResponse, error) {
...
func (c *bookServiceClient) SearchBook(ctx context.Context, in *SearchBookRequest, opts ...grpc.CallOption) (BookService_SearchBookClient, error) {
	stream, err := c.cc.NewStream(ctx, &BookService_ServiceDesc.Streams[1], "/grpc.BookService/SearchBook", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bookServiceClient) UpdateBook(ctx context.Context, in *UpdateBookRequest, opts ...grpc.CallOption) (*UpdateBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.BookService/UpdateBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) DeleteBook(ctx context.Context, in *DeleteBookRequest, opts ...grpc.CallOption) (*DeleteBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.BookService/DeleteBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	GetAllBook(*GetAllBookRequest, BookService_GetAllBookServer) error
...
func (UnimplementedBookServiceServer) GetAllBook(*GetAllBookRequest, BookService_GetAllBookServer) error {
...
func _BookService_CreateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.BookService/CreateBook",
	}
...
func _BookService_GetAllBook_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetAllBookRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BookServiceServer).GetAllBook(m, &bookServiceGetAllBookServer{stream})
}

type BookService_GetAllBookServer interface {
	Send(*GetAllBookResponse) error
	grpc.ServerStream
}

type bookServiceGetAllBookServer struct {
	grpc.ServerStream
}

func (x *bookServiceGetAllBookServer) Send(m *GetAllBookResponse) error {
...
func _BookService_UpdateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.BookService/UpdateBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookService_DeleteBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.BookService/DeleteBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/protofile/lms.proto",
}
